...
<div class="service-buttons">
    <a href="movieslogged.php?service=netflix"><button class="service-button" id="netflix-button">Netflix</button></a>
    <a href="movieslogged.php?service=disney"><button class="service-button" id="disney-button">Disney+</button></a>
    <div class="dropdown">
...
<script src="movieslogged.js"></script>
<script>
